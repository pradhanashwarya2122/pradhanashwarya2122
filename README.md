...
I'm an AI/ML engineer pursuing my **B.Tech in Computer Science (AI & ML)** at **Manipal University Jaipur**, working at the intersection of machine learning research and production-grade software engineering. My focus is **Generative AI**, **autonomous agents**, and **retrieval-augmented systems** — building intelligent software that ships, not just notebooks that stay local.

> ✨ *"I don't just train models — I build the systems that put them to work."*
...
<div align="center">
<img src="https://img.shields.io/badge/⚡-Production--Grade_Neural_Research_OS-F72585?style=for-the-badge&labelColor=1a1a2e" />
</div>

POLYNOUS is my flagship build — a full-stack multi-agent AI platform where **seven agents orchestrate via LangGraph** to search, summarize, critique, and write structured research reports, complete with real-time web citations, confidence scoring, and a personal knowledge graph per user.
